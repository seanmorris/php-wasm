...
const extensionAssets = require('./extension-assets.js');
const { nodeRuntimeOptions, resolveNodeTestEnv } = require('./node-runtime-options.cjs');
...
const runCliPhpt = async ({ phptFile, version, phpOptions = {} }) => {
