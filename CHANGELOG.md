...
* The Drupal/PostgreSQL artifact test uses fixed external release metadata so the install, login, and database checks do not depend on changes to Drupal's live update feed.
