...
packages/intl/php${PHP_VERSION}-intl.so: ${PHPIZE} third_party/php${PHP_VERSION}-intl/config.m4 packages/intl/libicudata.so packages/intl/libicuuc.so packages/intl/libicui18n.so packages/intl/libicuio.so packages/intl/libicutu.so /src/packages/intl/libicutest.so
