...
WORKER_CLI_MJS_ASSETS= $(addprefix ${PHP_CLI_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES} ${HELPER_MJS}
WORKER_CLI_JS_ASSETS= $(addprefix ${PHP_CLI_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES}
WEBVIEW_CLI_MJS_ASSETS= $(addprefix ${PHP_CLI_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES} ${HELPER_MJS}
WEBVIEW_CLI_JS_ASSETS= $(addprefix ${PHP_CLI_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES}
NODE_CLI_MJS_ASSETS= $(addprefix ${PHP_CLI_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES} ${HELPER_MJS}
...
WEB_CLI_MJS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.mjs.wasm.map.MAPPED
WEB_CLI_JS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.js.wasm.map.MAPPED
WORKER_CLI_MJS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs.wasm.map.MAPPED
WORKER_CLI_JS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs.wasm.map.MAPPED
WEBVIEW_CLI_MJS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.mjs.wasm.map.MAPPED
WEBVIEW_CLI_JS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.js.wasm.map.MAPPED
NODE_CLI_MJS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.mjs.wasm.map.MAPPED
NODE_CLI_JS_ASSETS+= ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.js.wasm.map.MAPPED
endif
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.js: FS_TYPE=${WEB_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.js: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.js.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-web.js.wasm.map ${PHP_CLI_DIST_DIR}

${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.mjs: BUILD_TYPE=mjs
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.mjs: ENVIRONMENT=web
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.mjs: FS_TYPE=${WEB_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.mjs: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.mjs.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-web.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-web.mjs.wasm.map ${PHP_CLI_DIST_DIR}

${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.js: BUILD_TYPE=js
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.js: ENVIRONMENT=worker
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.js: FS_TYPE=${WORKER_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.js: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.js.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-worker.js.wasm.map ${PHP_CLI_DIST_DIR}

${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs: BUILD_TYPE=mjs
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs: ENVIRONMENT=worker
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs: FS_TYPE=${WORKER_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-worker.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-worker.mjs.wasm.map ${PHP_CLI_DIST_DIR}

${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.js: BUILD_TYPE=js
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.js: ENVIRONMENT=node
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.js: FS_TYPE=${NODE_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.js: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.js.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-node.js.wasm.map ${PHP_CLI_DIST_DIR}

${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.mjs: BUILD_TYPE=mjs
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.mjs: ENVIRONMENT=node
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.mjs: FS_TYPE=${NODE_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.mjs: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.mjs.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-node.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-node.mjs.wasm.map ${PHP_CLI_DIST_DIR}

${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.js: BUILD_TYPE=js
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.js: ENVIRONMENT=webview
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.js: FS_TYPE=${WEB_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.js: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.js.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-webview.js.wasm.map ${PHP_CLI_DIST_DIR}

${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.mjs: BUILD_TYPE=mjs
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.mjs: ENVIRONMENT=webview
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.mjs: FS_TYPE=${WEB_FS_TYPE}
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.mjs: SAPI_CLI_PATH=sapi/cli/php${PHP_SUFFIX}-cli-${ENVIRONMENT}.${BUILD_TYPE}.${BUILD_TYPE}
...
${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.mjs.wasm.map.MAPPED: ${PHP_CLI_DIST_DIR}/php${PHP_SUFFIX}-cli-webview.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/cli/php${PHP_SUFFIX}-cli-webview.mjs.wasm.map ${PHP_CLI_DIST_DIR}
