...
await runSourceImporter({
	...
	, prefix: 'VRZNO'
	, label: 'Vrzno'
	, inputs: String.raw`^(?:[^/]+\.(?:c|h)|[^/]+\.h\.in|(?:js/)?(?:vrzno_[a-z_]+|php_stream_fetch_real_open)\.js|(?:js/)?vrzno_(?:weakermap|bundle)\.mjs|package(?:-lock)?\.json|[^/]+\.stub\.php|Makefile\.frag|config\.m4|CREDITS|LICENSE|NOTICE)$`
	, directories: ['js']
