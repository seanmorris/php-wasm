...
third_party/php$${PHP_VERSION}-src/ext/$(1)/config.m4: third_party/php$${PHP_VERSION}-$(1)/config.m4 packages/php-sdl-wasm/patches/$(1).patch packages/php-sdl-wasm/extensions.mak $(3) $(4) | third_party/php$${PHP_VERSION}-src/patched
	...
	$${DOCKER_RUN} patch --batch -d third_party/php$${PHP_VERSION}-$(1)-import -p1 -i /src/packages/php-sdl-wasm/patches/$(1).patch
...
$(eval $(call SDL_PECL,sdl_mixer,0.4.0,$(wildcard packages/php-sdl-wasm/mixer/*.h),$(wildcard packages/php-sdl-wasm/mixer/src/*.[ch])))
$(eval $(call SDL_PECL,sdl_ttf,0.3.0,$(wildcard packages/php-sdl-wasm/ttf/*.[ch])))
$(eval $(call SDL_PECL,opengl,0.9.0,$(wildcard packages/php-sdl-wasm/opengl/*.[ch])))
...
lib/lib/libSDL2_$(1).a: third_party/SDL2_$(1)-$(2)/configure lib/bin/sdl2-config packages/php-sdl-wasm/extensions.mak $(3)
