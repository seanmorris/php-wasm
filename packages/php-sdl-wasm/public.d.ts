...
/** Options for a version-bound browser SDL entry. */
export interface PhpSdlOptions extends PhpRuntimeArgs {
	version?: never;
	runtime?: never;
	canvas?: HTMLCanvasElement | OffscreenCanvas;
}
/** Low-level adapter input; version-bound entries supply the matching factory. */
export interface PhpSdlArgs extends PhpRuntimeArgs {
