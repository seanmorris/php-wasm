...
WEB_DBG_MJS=$(addprefix ${PHP_DBG_DIST_DIR}/,PhpDbgWeb.mjs php-dbg-web.mjs ${MJS_HELPERS_WEB})
WEB_DBG_JS=$(addprefix ${PHP_DBG_DIST_DIR}/,PhpDbgWeb.js php-dbg-web.js ${CJS_HELPERS_WEB})
WORKER_DBG_MJS=$(addprefix ${PHP_DBG_DIST_DIR}/,PhpDbgWorker.mjs php-dbg-worker.mjs ${MJS_HELPERS_WEB})
WORKER_DBG_JS=$(addprefix ${PHP_DBG_DIST_DIR}/,PhpDbgWorker.js php-dbg-worker.js ${CJS_HELPERS_WEB})
WEBVIEW_DBG_MJS=$(addprefix ${PHP_DBG_DIST_DIR}/,PhpDbgWebview.mjs php-dbg-webview.mjs ${MJS_HELPERS_WEB})
WEBVIEW_DBG_JS=$(addprefix ${PHP_DBG_DIST_DIR}/,PhpDbgWebview.js php-dbg-webview.js ${CJS_HELPERS_WEB})
...
WEB_DBG_MJS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-web.mjs.wasm.map.MAPPED
WEB_DBG_JS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-web.js.wasm.map.MAPPED
WORKER_DBG_MJS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-worker.mjs.wasm.map.MAPPED
WORKER_DBG_JS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-worker.mjs.wasm.map.MAPPED
WEBVIEW_DBG_MJS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-webview.mjs.wasm.map.MAPPED
WEBVIEW_DBG_JS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-webview.js.wasm.map.MAPPED
NODE_DBG_MJS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-node.mjs.wasm.map.MAPPED
NODE_DBG_JS_ASSETS+= ${PHP_DBG_DIST_DIR}/php-dbg-node.js.wasm.map.MAPPED
endif
