...
WORKER_DBG_MJS_ASSETS= $(addprefix ${PHP_DBG_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES} ${HELPER_MJS}
WORKER_DBG_JS_ASSETS= $(addprefix ${PHP_DBG_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES}
WEBVIEW_DBG_MJS_ASSETS= $(addprefix ${PHP_DBG_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES} ${HELPER_MJS}
WEBVIEW_DBG_JS_ASSETS= $(addprefix ${PHP_DBG_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES}
NODE_DBG_MJS_ASSETS= $(addprefix ${PHP_DBG_ASSET_DIR}/,${PHP_ASSET_LIST}) ${EXTRA_MODULES} ${HELPER_MJS}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-web.js: EXTRA_CFLAGS+=-D PHPDBG=1
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-web.mjs: EXTRA_CFLAGS+= -D PHPDBG=1
