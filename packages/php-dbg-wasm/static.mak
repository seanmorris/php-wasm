...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-web.js.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-web.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-web.js.wasm.map ${PHP_DBG_DIST_DIR}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-web.mjs.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-web.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-web.mjs.wasm.map ${PHP_DBG_DIST_DIR}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-worker.js.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-worker.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-worker.js.wasm.map ${PHP_DBG_DIST_DIR}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-worker.mjs.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-worker.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-worker.mjs.wasm.map ${PHP_DBG_DIST_DIR}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-node.js.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-node.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-node.js.wasm.map ${PHP_DBG_DIST_DIR}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-node.mjs.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-node.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-node.mjs.wasm.map ${PHP_DBG_DIST_DIR}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-webview.js.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-webview.js
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-webview.js.wasm.map ${PHP_DBG_DIST_DIR}
...
${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-webview.mjs.wasm.map.MAPPED: ${PHP_DBG_DIST_DIR}/php${PHP_SUFFIX}-dbg-webview.mjs
	${DOCKER_RUN} ./remap-sourcemap.sh third_party/php8.3-src/sapi/dbg/php${PHP_SUFFIX}-dbg-webview.mjs.wasm.map ${PHP_DBG_DIST_DIR}
